	...
	return(
	 <div className="example">
      <div className="bar bar-header">                                    
        ...
        <WhiteSpace />
        <Tabs defaultActiveKey="1" animated={false} className="positive" >
        ...
        <WhiteSpace />
         <WhiteSpace />
        <Tabs defaultActiveKey="1" animated={false} className="balanced" >
          <TabPane tab="选项卡一" key="1" >
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '2rem' }}>
               选项卡一内容
            </div>
        ...
        <WhiteSpace />
         <WhiteSpace />
        <Tabs defaultActiveKey="1" animated={false} className="energized" >
          <TabPane tab="选项卡一" key="1" >
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '2rem' }}>
               选项卡一内容
            </div>
